...
"""
    ...
    def test_update_1(self):
        """Tests update command for BaseModel."""
        classname = "BaseModel"
        attr = "foostr"
        val = "fooval"
        uid = self.create_class(classname)
    ...
    def test_update_4(self):
        """Tests update command for State."""
        classname = "State"
        attr = "foostr"
        val = "fooval"
        uid = self.create_class(classname)
    ...
    def test_update_5(self):
        """Tests update command for Amenity."""
        classname = "Amenity"
        attr = "foostr"
        val = "fooval"
        uid = self.create_class(classname)
    ...
    def test_update_6(self):
        """Tests update command for Review."""
        classname = "Review"
        attr = "foostr"
        val = "fooval"
        uid = self.create_class(classname)
    ...
    def test_update_7(self):
        """Tests update command for Place."""
        classname = "Place"
        attr = "foostr"
        val = "fooval"
        uid = self.create_class(classname)
    ...
    def test_update_everything(self):
        """Tests update command with various attributes."""
